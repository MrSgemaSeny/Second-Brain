...
- **Промпты:** БАЗИК (20 готовы) / ПРО (40) / МАСТЕР (78). Структура: [КОНТЕКСТ]/[ЗАДАЧА]/[ОГРАНИЧЕНИЯ]/[РЕЗУЛЬТАТ].
- **Инструменты студентов:** VS Code + Antigravity (Gemini Advanced) + Claude/ChatGPT/Grok.
- **Лог:** `journal/YYYY-MM-DD/mr-developer.md`

### Менторство: Ученик 1
- **Проект:** `projects/mentorship/mentor.md`
- **Статус:** Этап 0 — Среда и мышление (начало 2026-08-24)
- **Контекст:** Ученик — предприниматель с бизнесом и подчинёнными. До менторства: не было GitHub. Мотивация — самостоятельно делать продукты вместо найма разработчиков. Условие — честность.
- **Цели:** Вайбкодинг → архитектура проекта → сильный MVP → мобилка.
- **Стек:** React 19 + TypeScript + Vite + Tailwind v4 + FSD. Бэкенд позже (Spring Boot 3).
