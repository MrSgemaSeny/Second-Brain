...
- **Frontend сборка (`npm run build`)**: `built in 1.36s` (0 ошибок).
- **Frontend тесты (`npm test -- --run`)**: 10 сьютов, 38 тестов — **100% PASS**.
- **Backend компиляция (`gradlew compileJava testClasses`)**: **BUILD SUCCESSFUL**.
