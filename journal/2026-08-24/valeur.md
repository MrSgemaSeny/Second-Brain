...
- **Коммерческий Enterprise-релиз**: В активной реализации с 86 Vitest тестами на фронтенде и 92 E2E тестами.
...
- Фронтенд-фича `AiResumeScoring`: компоненты `AiMatchBadge`, `AiScoreBreakdownModal`, хук `useAiScoring` с отображением скоринга прямо в карточке отклика и на Kanban-доске.
...
- **Синхронизация Git**: Репозиторий [Valeur](https://github.com/MrSgemaSeny/Valeur) (`c24b6c7`).
