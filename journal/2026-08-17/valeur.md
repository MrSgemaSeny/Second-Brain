...
### ������ 5: ��������� Unit � �������������� ������
- **Frontend**: ���������� �������������� Vitest + React Testing Library. �������� ����� ��� ������ �������� (useApplyLogic.test.ts) � ������������� API (piClient.test.ts).
- **Backend**: �������� ����� MockMvc � JUnit 5 ��� identity-service (�����������, ��������� JWT), acancy-service (��������� ��������) � pplication-service (������ RestClient).
- ����� ������� �������������� � ��������. ��� ��������.
- **Fix**: �������� ��� � ���������� ������ TailwindCSS v4, ����� ���������� �� �������� CSS � index.css ��� ���������� ���������� Vite ��� @apply.
