...
- Терминология «День N» полностью заменена на «Урок N» во всех слоях приложения (CourseDetailPage, LessonPage, VisualRoadmap, ProgressView, RoadmapView, GlossaryView, AdminPage, DataSeeder, V12 Flyway SQL).
...
- Все 37 тестов Vitest и компиляция Gradle пройдены (100% green).
